...
<!-- 					<td class="invert">1</td> -->
					  <!--  	<td <a href="single.html"><img src="<c:url value="/resources/images/${p.id }.png"/>">class=" img-responsive" /></a>
			</td>-->
			<!--  	<td class="invert">
							 <div class="quantity"> 
	...
	<div class="checkout-left">
		...
		<div class="checkout-right-basket animated wow slideInRight"
			...
			<a href="${allProducts}"><span
				class="glyphicon glyphicon-menu-left" aria-hidden="true"></span>Continue
				Shopping</a> <a href="<spring:url value="/order/${cartId}"/>"><span
				class="glyphicon glyphicon-menu-right" aria-hidden="true"></span>Checkout</a>
